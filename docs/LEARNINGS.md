...
LLMs may return JSON inside markdown code blocks. So I created helper functions like:
...
3. The nearby and metro services work as MVP, but they need better production-level data sources and validation.
